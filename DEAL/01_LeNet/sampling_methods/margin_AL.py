...
"""Margin based AL method for Softmax.
...
class MarginAL(SamplingMethod):
  ...
  def select_batch_(self, model, already_selected, N, **kwargs):
    """Returns batch of datapoints with smallest margin/highest uncertainty for Softmax.
    ...
    try:
      distances = model.decision_function(self.X, self.test_time_dropout)
    except:

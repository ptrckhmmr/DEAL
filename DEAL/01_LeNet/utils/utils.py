...
from utils.lenet_evidence import LeNet_Evidence
from utils.lenet_softmax import LeNet_Softmax
...
def get_model(method, seed=13):
  ...
  if method == "LeNet_DEAL":
    model = LeNet_Evidence(random_state=seed)
  elif method == "LeNet_Softmax":
    model = LeNet_Softmax(random_state=seed)
  else:

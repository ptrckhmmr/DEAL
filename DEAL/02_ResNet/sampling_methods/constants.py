...
Registers all available sampling methods used in this work.
"""
...
def get_base_AL_mapping():
  ...
  from sampling_methods.entropy_EDL import entropyEDL
  from sampling_methods.uncertainty_EDL import uncertaintyEDL
  from sampling_methods.varRatio import VarRatio
  from sampling_methods.varRatio_ensemble import VarRatio_ensemble
  from sampling_methods.margin_EDL import MarginEDL
  from sampling_methods.varRatioEDL import VarRatioEDL
  AL_MAPPING['margin'] = MarginAL
  AL_MAPPING['uniform'] = UniformSampling
  AL_MAPPING['kcenter'] = kCenterGreedy
  AL_MAPPING['entropyEDL'] = entropyEDL
  AL_MAPPING['uncertaintyEDL'] = uncertaintyEDL
  AL_MAPPING['varRatio'] = VarRatio
  AL_MAPPING['varRatio_ensemble'] = VarRatio_ensemble
  AL_MAPPING['marginEDL'] = MarginEDL
  AL_MAPPING['varRatioEDL'] = VarRatioEDL
